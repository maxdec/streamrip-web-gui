      ...
      (result) => `
        <div class="search-result-item" data-id="${result.id}" data-source="${result.service}" data-type="${result.type}">
            ...
            <div class="result-info">
                ...
                ${result.year || result.label || result.track_count ? `<div class="result-meta">${result.year ? result.year : ""}${result.year && (result.label || result.track_count) ? " • " : ""}${result.label ? result.label : ""}${result.label && result.track_count ? " • " : ""}${result.track_count ? result.track_count + " tracks" : ""}</div>` : ""}
